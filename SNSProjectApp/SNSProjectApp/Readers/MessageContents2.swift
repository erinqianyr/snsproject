...
class MessageContents2: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        messageTitle.text = messageTitles2[myIndex2]
        messageContent.text = messageContents2[myIndex2]
        messageContent.isEditable = false
        
        
        Alamofire.request(MyVariables.url + "/message_media?mid=" + messageMID2[myIndex2], method: .get, encoding: URLEncoding.default)
