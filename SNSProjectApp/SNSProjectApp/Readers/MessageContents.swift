...
class MessageContents: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        messageTitle.text = messageTitles[myIndex]
        messageContent.text = messageContents[myIndex]
        messageContent.isEditable = false
        Alamofire.request(MyVariables.url + "/message_media?mid=" + messageMID[myIndex], method: .get, encoding: URLEncoding.default)
