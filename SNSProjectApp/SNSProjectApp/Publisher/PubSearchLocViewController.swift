//
//  PubSearchLocViewController.swift
//  SNSProjectApp
//
...
class PubSearchLocViewController: UIViewController, UISearchBarDelegate {
    ...
    @IBAction func send_loc(_ sender: Any) {
        let t = storyboard?.instantiateViewController(withIdentifier: "PubSearchCatViewController") as! PubSearchCatViewController
